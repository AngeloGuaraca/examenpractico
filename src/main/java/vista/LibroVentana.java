...
public class LibroVentana extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Codigo Categorias:");
...
private void actulizarTabla1 () {
        ...
        encabezado[0]="Categorias";
        encabezado[1]="Codigo";
        encabezado[2]="Nombre";
        encabezado[3]="Año";
        
        var datos = new Object[this.libroControlador.listar().size()][4];
        
        var i=0;
        for(var libro:this.libroControlador.listar())
        {
            datos[i][0]=libro.getCategorias().getDescripcion();
